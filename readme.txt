...
Add a block to display an embedded frame in the WordPress editor.
...
1. Upload the plugin files to the `/wp-content/plugins/blockparty-iframe` directory, or install the plugin through the WordPress plugins screen directly.
...
* Developer dependencies: remove Psalm static analysis (smaller Composer dev footprint); PHPCS and existing quality tasks remain.
